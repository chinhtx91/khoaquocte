 ...
 * @Createdate Tue, 01 Sep 2015 23:39:39 GMT
 */
...
$global_config['cookie_prefix']='nv4c_Xqm2e';
...
$global_config['ftp_user_pass']='HbvLT4HKQGzvbOUVyDHWUh27y0-BykBs72zlFcgx1lI,';
...
$global_config['session_prefix']='nv4s_Vrsc2v';
...
$rewrite_keys=array(0=>'#"(/khoaquocte.my/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=seek\\&[amp;]*q\\=([^"]+)"#', 1=>'#"(/khoaquocte.my/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=search\\&[amp;]*q\\=([^"]+)"#', 2=>'#"(/khoaquocte.my/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=tag/([^"]+)"#', 3=>'#"(/khoaquocte.my/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=([a-zA-Z0-9-/]+).html"#', 4=>'#"(/khoaquocte.my/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=([a-zA-Z0-9-/]+)"#', 5=>'#"(/khoaquocte.my/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-/]+)"#', 6=>'#"(/khoaquocte.my/)index.php\\?language=([a-z-]+)"#');
